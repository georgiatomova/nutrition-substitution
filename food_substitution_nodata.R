...
MeanGrams <- c(209.43703, 256.08394, 113.18604, 38.40991, 249.02112, 17.48802, 366.01758, 1006.79492, 76.21392)
names(MeanGrams) <- c("CEREAL","DAIRY","MEAT","FISH","FVP","NUT","ALCO","NONALC","MISC")
MeanGrams
